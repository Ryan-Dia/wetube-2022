...
var s3ImageUploader = new _clientS.PutObjectCommand({
  Bucket: "wetube--2022",
  Key: "imges/",
  ACL: "bucket-owner-full-control",
  ContentLength: 42
});
var s3VideoUploader = new _clientS.PutObjectCommand({
  Bucket: "wetube--2022",
  Key: "videos/",
  ACL: "bucket-owner-full-control",
  ContentLength: 42
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return s3.send(s3ImageUploader);

        case 3:
          _context.next = 5;
          return s3.send(s3VideoUploader);
